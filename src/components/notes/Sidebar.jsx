...
function Sidebar({ className }) {
  ...
  // Creating a function to verify if current path matches 
  const isActive = (path) => {
    return location.pathname === path;
  };

  const tagMatch = location.pathname.match(/^\/tags\/(.+)$/);
  const activeTag = tagMatch ? decodeURIComponent(tagMatch[1]) : null;
        ...
        <ul className={styles.navList}>
          ...
          <li className={`${styles.navItem} ${isActive('/dashboard') ? styles.active : ''}`}>
            <Link to="/dashboard" className={styles.navLink}>
              ...
              >
                <path
                  fill={isActive('/dashboard') ? "#3356FF" : "#0E121B"}
                  fillRule="evenodd"
          ...
          {/* ARCHIVED NOTES */}
          <li className={`${styles.navItem} ${isActive('/archived') ? styles.active : ''}`}>
            <Link to="/archived" className={styles.navLink}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
              ...
              >
                <path
                  stroke={isActive('/archived') ? "#3356FF" : "#0E121B"}
                  strokeLinecap="round"
